...
class FilterShell:
    ...
    def content(self, ext, ctent):
        if ext == "php":
            for word in list(php_sensitive_words.keys()):
                if word in ctent:
            ...
            for word in list(asp_sensitive_words.keys()):
                if word in ctent:
                    return asp_sensitive_words.get(word)
                else:
                    return False
        elif ext == "aspx":
            for word in list(aspx_sensitive_words.keys()):
                if word in ctent:
                    return aspx_sensitive_words.get(word)
                else:
                    return False
        elif ext == "jsp":
            for word in list(jsp_sensitive_words.keys()):
                if word in ctent:
            ...
            for word in list(all_sensitive_words.keys()):
